...
**下一步**: **A3 · ISSUE-014** ✅ → **ISSUE-004** ✅ → **ISSUE-003** ✅ → A3 P2 按需 (009/010 …) 或并行 **B2-v0** / **C1**
...
| **A3** | **P2**   | **014** ✅; **004** ✅ (doc-only); **003** ✅; 按需 009/010 … | [ ] |
...
```text
aidb 001+002+005 ✅ → aikv 002 ✅ → aikv 006 ✅ → P1 (001/012/013/016) ✅ → A4 doc-only ✅ → 014 ✅ → 004 ✅ → 003 ✅ → P2 按需
```
